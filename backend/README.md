...
## Project Structure
    ...
    ├── service_provider_te_37711  # Django project configurations
...
1. Clone this repo and `cd service_provider_te_37711`
...
2. Clone this repo and `cd service_provider_te_37711`
